...
@property (nonatomic, copy) NSString *image0; /*< 图片的URL */
@property (nonatomic, copy) NSString *image1; /*< 图片的URL */
@property (nonatomic, copy) NSString *image2; /*< 图片的URL */


@property (nonatomic, assign, readonly) CGFloat cellHeight; /**< 帖子内容的高度 */
@property (nonatomic, assign) CGFloat contentLabelMaxH; /**< 文字内容的最大Y值 */
